  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="{{asset('js/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
      </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        <a href="{{route('user-list')}}">
          ...
          <span class="pull-right-container">
            <span class="label label-primary pull-right bg-green">
              13
            </span>
          </span>
        </a>
      ...
      <li>
        <a href="#">
          ...
          <span class="pull-right-container">
            <span class="label label-primary pull-right bg-green">15</span>
          </span>
        </a>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="{{route('import-bill')}}"><i class="fa fa-circle-o"></i> Nhập hàng</a></li>
